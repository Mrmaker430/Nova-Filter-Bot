...
@Client.on_message(filters.group & filters.incoming & ~filters.service)
async def link_remover_handler(client, message):
    ...
    if has_link:
        ...
        try:
            ...
            warning_msg = await message.reply_text(warning_text, parse_mode=enums.ParseMode.HTML)
